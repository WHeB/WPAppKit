...
public class WPWebView: UIView {
    ...
    fileprivate func setupUI(webConfig:WkwebViewConfig)  {
        ...
        progressView.frame = CGRect(x: 0, y: 0, width: webView.frame.size.width, height: webConfig.progressHeight)
...
extension WPWebView: WKScriptMessageHandler{
...
extension WPWebView: WKNavigationDelegate{
...
extension WPWebView: WKUIDelegate{
